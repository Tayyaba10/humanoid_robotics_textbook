...
-   Follow the [File Naming Conventions](specs/1-humanoid-robotics-textbook/contracts/file-naming-conventions.md) and [MDX Frontmatter Standard](specs/1-humanoid-robotics-textbook/contracts/mdx-frontmatter-standard.md).
-   Ensure all technical claims are backed by [Citations](specs/1-humanoid-robotics-textbook/contracts/citation-format.md).
-   Tag glossary terms using the [Glossary Term Tagging Convention](specs/1-humanoid-robotics-textbook/contracts/glossary-term-tagging.md).
-   Adhere to the project's [Constitution](.specify/memory/constitution.md) and [Specification](specs/1-humanoid-robotics-textbook/spec.md).
